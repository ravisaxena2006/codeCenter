...
//define('AWS_API_KEY', 'AKIAJ5B3PBYNNBG2BXXQ');
define('AWS_API_KEY', 'AKIAIGLELJLS3LI4HT3Q');

define('AWS_API_SECRET_KEY', '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 ');

define('AWS_ASSOCIATE_TAG', 'aws');
